...
while($philosophy_fp->have_posts()){
    ...
    $post_data[] = array(
        ...
        'cat' => $categories[mt_rand(0, count($categories)-1)]->name, //to show random cateory
    );
}
                    ...
                    <div class="featured__column featured__column--big">
                        ...
                        <div class="entry" style="background-image:url('<?php echo esc_url( $post_data[0]['thumbnail'] );?>');">
                            ...
                            <div class="entry__content">
                                ...
                                <h1>
                                    <a href="#0" title=""><?php echo esc_html( $post_data[0]['title'] );?></a>
                                </h1>
                    ...
                    <?php  for($i = 1; $i<3; $i++): ?>
                        ...
                        <div class="entry" style="background-image:url('<?php echo esc_url( $post_data[$i]['thumbnail'] );?>');">
                            ...
                            <div class="entry__content">
                                ...
                                <h1>
                                    <a href="#0" title=""><?php echo esc_html( $post_data[$i]['title'] );?></a>
                                </h1>
